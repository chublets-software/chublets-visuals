...
Produces:
  img/chublets-curate-workflow.svg / .png (transparent)
...
ACCENT = FOUR_STEPS[2]["color"]  # gold -- same as the Curate & Link badge
...
def run(strict: bool = False) -> list[str]:
    ...
    svg_path = IMG_DIR / "chublets-curate-workflow.svg"
